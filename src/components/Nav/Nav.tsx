...
import logo4 from '../../assets/img/AVAXF.png';
import logohshare2 from '../../assets/img/FRZN.png';
import useTombStats from '../../hooks/useTombStats';
import usetShareStats from '../../hooks/usetShareStats';

const logo = require('../../assets/img/FB_White_Circle.png');
      ...
      <Toolbar className={classes.toolbar}>
        {matches ? (
          <>
            ...
            <Box style={{ marginRight:'38%', color: "#000000"}}>
          ...
          <>
            ...
            >
              ...
              <List>
                ...
                <ListItemLink primary="Farms" to="/crete" />
                <ListItemLink primary="Staking" to="/olympus" />
                <ListItemLink primary="Bonds" to="/tartarus" />
