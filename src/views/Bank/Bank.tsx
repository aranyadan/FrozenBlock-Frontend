      ...
      <Box>
        <Grid container justify="center" spacing={3} style={{ marginBottom: '50px' }}>
          <Grid item xs={12} md={2} lg={3} className={classes.gridItem}>
            <Card style={{background: '#FFFFFF', borderRadius: '15px', height: '120px'}} className={classes.gridItem}>
              <CardContent style={{ textAlign: 'center' }}>
                <h3 style={{ color: '#000000'}}>APR</h3>
          ...
          <Grid item xs={12} md={2} lg={3} className={classes.gridItem}>
            <Card style={{background: '#FFFFFF', borderRadius: '15px', height: '120px'}} className={classes.gridItem}>
              <CardContent style={{ textAlign: 'center' }}>
                <h3 style={{ color: '#000000'}}>Daily APR</h3>
          ...
          <Grid item xs={12} md={2} lg={3} className={classes.gridItem}>
            <Card style={{background: '#FFFFFF', borderRadius: '15px', height: '120px'}} className={classes.gridItem}>
              <CardContent style={{ textAlign: 'center' }}>
                <h3 style={{ color: '#000000'}}>Total Value Locked</h3>
